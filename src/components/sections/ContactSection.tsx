...
import { MapPin, Phone, Mail, Clock, Navigation, Instagram, MessageCircle, Send } from "lucide-react";
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg shadow-black/5 border border-gray-100">
                ...
                <a 
                  ...
                  className="text-[#1a1a1a] hover:text-[#2d2d2d] transition-colors text-sm font-medium"
                >
                  {siteConfig.phone}
                </a>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg shadow-black/5 border border-gray-100">
                ...
                <a 
                  ...
                  className="text-[#1a1a1a] hover:text-[#2d2d2d] transition-colors text-sm font-medium break-all"
                >
                  {siteConfig.email}
                </a>
              </div>
